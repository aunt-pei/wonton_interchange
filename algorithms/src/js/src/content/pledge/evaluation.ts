...
function evaluateCombiner<T>(
  combiner: wonton_interchange_protobufs.com.auntpei.wonton.PledgeConditionCombinerFunction.Enum,
  clauses: T[],
  ...
  switch (combiner) {
    case wonton_interchange_protobufs.com.auntpei.wonton
...
function evaluateComparator<T>(
  comparator: wonton_interchange_protobufs.com.auntpei.wonton.PledgeConditionComparatorFunction.Enum,
  left: T,
  right: T,
...
function evaluatePledgeWhere(
  where: wonton_interchange_protobufs.com.auntpei.wonton.PledgeConditionWhere,
...
function evaluatePledgePredicate(
  predicate: wonton_interchange_protobufs.com.auntpei.wonton.PledgeConditionPredicate,
...
export function evaluatePledgeStatuses(
  pledgeInfos: {
    [pledgeId: string]: {
      domainName: string;
      commitmentConditionStructured: wonton_interchange_protobufs.com.auntpei.wonton.PledgeCondition;
      commitmentValueUsd: Long;
    };
  },
  universityMetadata: {
  ...
  [
    pledgeId: string
  ]: wonton_interchange_protobufs.com.auntpei.wonton.PledgeStageStatusRegistered;
} {
  ...
  for (const [pledgeId, pledgeInfo] of Object.entries(pledgeInfos)) {
    if (!(universityMetadata[pledgeInfo.domainName]?.enabled || false)) {
      pledgeStatuses[pledgeId] =
        new wonton_interchange_protobufs.com.auntpei.wonton.PledgeStageStatusRegisteredConditionStatusUnsatisfied(
          {
    ...
    switch (pledgeStatus.status) {
      case 'satisfied':
        pledgeStatuses[pledgeId] =
          new wonton_interchange_protobufs.com.auntpei.wonton.PledgeStageStatusRegisteredConditionStatusSatisfied();
        break;
      case 'unsatisfied':
        new wonton_interchange_protobufs.com.auntpei.wonton.PledgeStageStatusRegisteredConditionStatusUnsatisfied(
          {
